...
#
# Generated by Vivado on Thu Nov 10 19:00:26 CST 2022
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic" \
    "$ref_dir/../../../../tinyriscv_arty_100t.gen/sources_1/ip/clk_wiz_0/clk_wiz_0_clk_wiz.v" \
    "$ref_dir/../../../../tinyriscv_arty_100t.gen/sources_1/ip/clk_wiz_0/clk_wiz_0.v" \
  2>&1 | tee -a vlogan.log
...
create_lib_mappings()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/root/tinyriscv_arty_100t/tinyriscv_arty_100t.cache/compile_simlib/vcs"
  fi
